...
QMAKE    = /usr/bin/qmake
MoodSearch.pbproj/project.pbxproj: MoodSearch.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o MoodSearch.pbproj/project.pbxproj MoodSearch.pro
